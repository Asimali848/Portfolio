...
// };
// export default Nav;
import { FtxToken, Gallery, Hierarchy2 } from "iconsax-react";
import { Link, useNavigate } from "react-router-dom";
...
const Nav = () => {
  ...
  return (
    <nav className="fixed inset-x-0 top-5 z-20 w-full px-3 md:px-0">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between rounded-full bg-white/8 py-2.5 pr-2.5 pl-5 backdrop-blur-3xl">
        {/* Logo */}
        ...
        <div className="hidden md:block">
          ...
          >
            Connect
            <Hierarchy2 className="size-4 fill-white" variant="Bold" />
          </Button>
        </div>
        ...
        <div className="px-4 md:hidden">
          <Sheet >
            ...
            <SheetContent side="right" className="w-64 bg-black/50 border-none p-6 text-white backdrop-blur-sm">
              <div className="mt-6 flex flex-col gap-6">
                ...
                <Button
                  type="button"
                  variant="default"
                  className="mt-4 w-full rounded-full text-lg text-white"
                  onClick={() => navigate("/contact")}
                >
                  Connect
                  <Hierarchy2 className="size-6 fill-white" variant="Bold" />
                </Button>
              </div>
            </SheetContent>
          </Sheet>
